...
deno run -A skills/wod-imagegen/generate.ts --exercise barre-bent-leg-side-lift --no-ref --jpg

# With custom quality (1-100, default 80)
deno run -A skills/wod-imagegen/generate.ts --exercise bird-dog --no-ref --jpg --quality 60

# Or with custom prompt
deno run -A skills/wod-imagegen/generate.ts \
...
```bash
# Default quality (80)
deno run -A skills/wod-imagegen/generate.ts --exercise bird-dog --no-ref --jpg
